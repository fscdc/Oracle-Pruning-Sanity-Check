    ...
    do
        ...
        do
            CUDA_VISIBLE_DEVICES=$i python main.py --no_ddp --no_scp \
                ...
                --stage_pr "*conv3*:$stage_pr" \
                --lr_ft 0:0.001,20:1e-4 --epochs 30 \
                --weight_decay 1e-4 \
                --batch_oracle $i \
                --experiment_name oracle__lenet5_mini__mnist__prconv3${stage_pr//./}__epoch30_lr0.001to0.0001 > ./record/conv3${stage_pr//./}_lr2_t$t\_batch$i.txt &
        done
        wait
        ...
        CUDA_VISIBLE_DEVICES=6 python main.py --no_ddp --no_scp --test_pretrained \
            ...
            --weight_decay 1e-4 \
            --experiment_name l1__lenet5_mini__mnist__conv30.5 > ./record/conv3${stage_pr//./}_lr2_l1_t$t.txt &
    done
done
