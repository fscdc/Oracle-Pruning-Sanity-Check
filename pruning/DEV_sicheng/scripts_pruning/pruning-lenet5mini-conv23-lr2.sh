...
CUDA_VISIBLE_DEVICES=0 python main.py --no_ddp --no_scp \
    ...
    --stage_pr *conv2*:0.5,*conv3:0.5 \
    --lr_ft 0:0.001,20:1e-4 --epochs 30 \
    --weight_decay 1e-4 \
    --batch_oracle 0 \
    --random yes \
    --save_combination yes \
    --experiment_name oracle__lenet5_mini__mnist__prconv230.50.5__lr2__savecombination
...
do
    ...
    do
        CUDA_VISIBLE_DEVICES=$i python main.py --no_ddp --no_scp \
            ...
            --random yes \
            --save_combination no \
            --experiment_name oracle__lenet5_mini__mnist__prconv230.50.5__lr2_t$t\_batch$i > ./record/conv20.530.5_lr2_t$t\_batch$i.txt &
    done
    wait
    ...
    CUDA_VISIBLE_DEVICES=6 python main.py --no_ddp --no_scp \
        ...
        --weight_decay 1e-4 \
        --experiment_name l1__lenet5_mini__mnist__prconv230.50.5_t$t > ./record/conv20.530.5_lr2_l1_t$t.txt &    
done